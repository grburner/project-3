...
const retailerSeed = [
  {user_id: 'ObjectId("5f90df97d56aef06bcb010d3")', name: 'Tri State Wine Co', address_street1: '128 Bransten Rd', address_street2: '2nd driveway', address_city: 'New York', address_state: 'NY', address_zip: '10011', phone_number: '212-675-8570', ships_to: ['NY', 'PA', 'VT']},
  {user_id: 'ObjectId("5f90df97d56aef06bcb010d4")', name: 'Parkway Winery', address_street1: '17 Morena Blvd', address_street2: '', address_city: 'Camarillo', address_state: 'CA', address_zip: '93012', phone_number: '805-832-6163', ships_to: ['CA', 'WA', 'NV']},
  {user_id: 'ObjectId("5f90df97d56aef06bcb010d5")', name: 'Red, White, and Rose!', address_street1: '775 W 17th St', address_street2: 'Ste 8003', address_city: 'San Antonio', address_state: 'TX', address_zip: '78204', phone_number: '210-812-9597', ships_to: ['TX']},
  {user_id: 'ObjectId("5f90df97d56aef06bcb010d6")', name: 'ChardonYAY', address_street1: '6980 Dorsett Rd', address_street2: '1st floor', address_city: 'Abilene', address_state: 'KS', address_zip: '67410', phone_number: '785-463-7829', ships_to: ['KS', 'KY', 'FL', 'LA']},
  {user_id: 'ObjectId("5f90def5747f0b4e289d05e9")', name: 'Prineville Vinyards', address_street1: '2881 Lewis Rd', address_street2: '', address_city: 'Prineville', address_state: 'OR', address_zip: '97754', phone_number: '541-548-8197', ships_to: ['OR', 'CA', 'WA']}
];
...
const productSeed = [
  ...
  { _id: 'ObjectId("5f90e02f0f4cef1b1ca22787")', retailer_id: 'ObjectId("5f90df97d56aef06bcb010d5")', name: 'WEST & WILDER CHENIN BLANC CAN', description: 'a delicious wine', country: 'US', geo2: 'geo2', type1: 'white', type2: 'still', size: '750mL', grape_blend: 'concord', units: 5, price: 9},
